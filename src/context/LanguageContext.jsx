...
export const translations = {
  de: {
    nav: { home: 'Home', projects: 'Projekte', about: 'Über uns', contact: 'Kontakt', login: 'Free AI basics: OptAInum', demo: 'Demo buchen' },
    hero: {
  ...
  en: {
    nav: { home: 'Home', projects: 'Projects', about: 'About', contact: 'Contact', login: 'Free AI basics: OptAInum', demo: 'Book Demo' },
    hero: {
